...
<div class="card shadow mb-4">
  ...
  <?php
$registros=$base->query("SELECT DISTINCT  codigo_pedido FROM  tempsalidas WHERE estado='Pendiente' AND oficina='$oficina' ORDER BY Id")->fetchAll(PDO::FETCH_OBJ);
    foreach($registros as $persona):

$factura_pendiente= $persona->codigo_pedido;
$registros1=$base->query("SELECT *, SUM(costoU*cantidad) AS monto FROM tempsalidas WHERE codigo_pedido='$factura_pendiente' AND oficina='$oficina'")->fetchAll(PDO::FETCH_OBJ);  
$monto1=0;
