...
$("#btnNuevo").click(function(){
    $(".modal-title").text("Agregar Nueva Salida");
...
$(document).on("click",".btnEditartemp",function(){
    ...
    $(".modal-title").text("Salida pendiente");
    $(".modal-header").css("background-color","#4e6c2a");
    $(".modal-header").css("color","white");
...
$("#mModificar").submit(function(e){
  ...
  $(".modal-title-imprimir").text("Deseas imprimir la orden de Salida #"+id+ "...?");
...
$("#mImprimir").submit(function(e){
  e.preventDefault();
    ...
    $.ajax({
      url:"../modificar/actualiza_salida.php",
    ...
    window.open("../salida/salidaimpresion.php?refact="+cod_fact); 
