...
<head>
  ...
  <title>Mercadito C & L Sofia's - Reportes productos creados</title>
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Reporte Creación de Producto</h1>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <form id="creacion">
    <div class="row">
    <div class="col-6 col-sm-4" id="creacion" >
    <input class="form-control bg-light border-1 small" id="fechacreacion" required type="text" placeholder="AAAA-MM-DD">
    </div>
    <div class="" style="border:1px;">
    <input class='btn btn-primary' type="submit"  id="creacion" value="Generar reporte"></input>        
