...
$pdf->Cell(60,4,utf8_decode('Reporte de existencias'),0,1,'C');
$pdf->Ln(3);
$registros=$base->query("SELECT * FROM  activossigua WHERE oficina='$bodega' AND cantidad>0 AND Estado='Activo' AND tipo='Activo'")->fetchAll(PDO::FETCH_OBJ);
$pdf->SetY(55);
$pdf->SetFont('Courier', 'B', 14);
$pdf->Write(5,utf8_decode('En la presente se desglosa los activos existentes en inventario de esta sucursal con fecha '.$factura ));
$pdf->Ln(8);
$pdf->SetFont('Helvetica', 'B', 14);
