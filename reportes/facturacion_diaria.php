...
<head>
  ...
  <title>Mercadito C & L Sofia's - Reporte de Facturación diaria</title>
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Reporte de Facturación diaria</h1>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <form id="facturaboton">
    <div class="row">
    <div class="col-6 col-sm-4" id="facturaboton" >
    <input class="form-control bg-light border-1 small" id="fechafactura" required type="text" placeholder="AAAA-MM-DD">
    </div>
    <div class="" style="border:1px;">
    <input class='btn btn-primary' type="submit" id="facturaboton" value="Generar reporte"></input>        
