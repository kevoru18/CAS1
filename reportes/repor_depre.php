...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Reporte depreciación</h1>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <form id="depreciacion">
    <div class="row">
    <div class="col-6 col-sm-4" id="depreciacion" >
    <input class="form-control bg-light border-1 small" id="fechadepreciacion" required type="text" placeholder="AAAA-MM-DD">
    <input type="hidden" class='form-control' value='<?php echo $oficina ?>'id="officedepreciacion">
    </div>
    <div class="" style="border:1px;">
    <input class='btn btn-primary' type="submit" id="trasladoboton" value="Generar reporte"></input>        
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Reporte de depreciación</h1>
<p class="mb-4"><?php echo $_SESSION["nombre"]?></p>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <label> Seleccione la Oficina</label>
          <select class='form-control' id="officedepreciacion">
                <option >Siguatepeque</option>
