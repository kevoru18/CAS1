...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Reporte Entradas por traslado</h1>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <form id="trasladoboton">
    <div class="row">
    <div class="col-6 col-sm-4" id="trasladoboton" >
    <input class="form-control bg-light border-1 small" id="fechatraslado" required type="text" placeholder="AAAA-MM-DD">
    <input type="hidden" class='form-control' value='<?php echo $oficina ?>'id="officeentrada">
    </div>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <label> Seleccione la Oficina</label>
          <select class='form-control' id="officeentrada">
                <option >Siguatepeque</option>
