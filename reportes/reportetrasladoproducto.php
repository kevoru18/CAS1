...
$pdf->Cell(60,4,utf8_decode('Reporte de entrada por traslado'),0,1,'C');
$pdf->SetFont('Helvetica', 'B', 14);
$pdf->Cell(10, 10, utf8_decode('Fecha: '.$factura), 0);

$pdf->Ln(5);
$pdf->Cell(10, 10, utf8_decode('Entradas de la sucursal '.$bodega), 0);

$pdf->Ln(8);
$registros=$base->query("SELECT * FROM  tempentrada WHERE  fecha_creacion_factura='$factura' ")->fetchAll(PDO::FETCH_OBJ);
