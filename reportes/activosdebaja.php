...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Reporte General de Activos dados de baja</h1>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <form id="bajaboton">
    <div class="row">
    <div class="col-6 col-sm-4" id="bajaboton" >
    <input class="form-control bg-light border-1 small" autocomplete="off" id="fechabaja" required type="text" placeholder="AAAA-MM-DD">
    
          <input type="hidden" value='<?php echo $oficina?>'class='form-control' id="officebaja">
                
    </div>
    <div class="" style="border:1px;">
    <input class='btn btn-primary' type="submit" id="bajaboton" value="Generar reporte"></input>        
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <label> Seleccione la Oficina</label>
          <select class='form-control' id="officebaja">
                <option >Siguatepeque</option>
