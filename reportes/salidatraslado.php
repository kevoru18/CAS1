...
$pdf->Cell(60,4,utf8_decode('Reporte de salida de artículos'),0,1,'C');
$pdf->SetFont('Helvetica', 'B', 14);
$pdf->Cell(10, 10, utf8_decode('Fecha: '.$factura), 0);

$pdf->Ln(5);
$pdf->Cell(10, 10, utf8_decode('Salidas de la sucursal '.$bodega), 0);

$pdf->Ln(8);

$registros=$base->query("SELECT * FROM  tempsalidas WHERE  fecha_creacion_factura='$factura' AND oficina='$bodega'")->fetchAll(PDO::FETCH_OBJ);
...
$pdf->MultiCell(100,4,$codigo_produc,0,'L'); 
