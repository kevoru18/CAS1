...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Reporte Salidas por traslado</h1>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <form id="salidaboton">
    <div class="row">
    <div class="col-6 col-sm-4" id="salidaboton" >
    <input class="form-control bg-light border-1 small" id="fechasalida" required type="text" placeholder="AAAA-MM-DD">
    <input type="hidden" class='form-control' value='<?php echo $oficina ?>'id="officesalida">
    </div>
    <div class="" style="border:1px;">
    <input class='btn btn-primary' type="submit" id="salidaboton" value="Generar reporte"></input>        
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <label> Seleccione la Oficina</label>
          <select class='form-control' id="officesalida">
                <option >Siguatepeque</option>
