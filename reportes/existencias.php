...
if ($permiso==="Contador") {
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Reporte General de Existencias</h1>
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <form id="existenciasboton">
      <div class="row">
      <div class="col-6 col-sm-4" id="existenciasboton" >
      <input class="form-control bg-light border-1 small" autocomplete="off" id="fechaexistencia" required type="text" placeholder="AAAA-MM-DD">
      
            <input type="hidden" class='form-control' value='<?php echo $oficina ?>'id="officeinven">
                  
            
      </div>
      <div class="" style="border:1px;">
      <input class='btn btn-primary' type="submit" id="existenciasboton" value="Generar reporte"></input>        
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <label> Seleccione la Oficina</label>
          <select class='form-control' id="officeinven">
                <option >Siguatepeque</option>
