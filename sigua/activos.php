...
if ($permiso==="Administrador") {
  header("location:activosigua.php");
  ...
  <title>CAS COMIXMUL - Activos</title>
       ...
       <li class="nav-item">
        ...
        <div id="collapsePagesActivos" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="activos.php">Oficina</a>
     ...
     <li class="nav-item">
        ...
        <div id="collapsePagesSuministros" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Oficinas:</h6>
            <!--<a class="collapse-item" href="login.html">Login</a>-->
            <a class="collapse-item" href="suministros.php">Oficina</a>
            <div class="collapse-divider"></div>
          </div>
        </div>
      </li>
  ...
  <li class="nav-item">
        ...
        <div id="collapsePagesProveedores" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Oficinas:</h6>
            <!--<a class="collapse-item" href="login.html">Login</a>-->
            <a class="collapse-item" href="proveedores.php">Oficina</a>
            <div class="collapse-divider"></div>
          </div>
        </div>
      </li>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <button id="btnDepreciacioncontador" type="button" href="#" class="btn btn-secondary btn-lg active btn btn-sm" data-toggle="modal" >Generar Depresiación <i class="fas fa-plus-circle"></i></button>
  </div>
...
<div class="modal fade" id="modalagregar"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <label>Descripción</label><input type="text" required class="form-control input-sm" id="namea" >
            <label >Valor en libros</label><input type="text" required class="form-control input-sm" id="phonea" >
            <label >Ubicación</label><input type="text" required class="form-control input-sm" id="positiona" >
            ...
            <label >Vida Útil(años)</label><input type="text"  class="form-control input-sm" id="vidautil" >
            <label >Marca</label><input type="text"  class="form-control input-sm" id="marca" >
            <label >Modelo</label><input type="text"  class="form-control input-sm" id="modelo" >
            <label >Serie</label><input type="text"  class="form-control input-sm" id="serie" >   
        </div>
  ...
  <!-- Modal Depreciación-->
  <div class="modal fade" id="modaDepreciacioncontador"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="row">
              <div class="modal-body col-sm-4">
                ...
                <div class="modal-body col-sm-4">
                        ...
                        <label>Familia</label><select  class='form-control' id="familiamodificar">
                                                  <option value="1">Equipos de computo</option>
                                                  <option value="2">Mobiliario y Equipo</option>
                                                  <option value="3">Vehiculos terrestres</option>
                                                  <option value="4">Edificios</option>
